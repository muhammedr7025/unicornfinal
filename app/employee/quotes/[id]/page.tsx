                ...
                <TableBody>
                  ...
                  {quote.pricing_type === 'custom' && customLabel && customPricingPrice > 0 && (
                    <TableRow className="bg-muted/20">
                      ...
                      {isIntl && <TableCell className="text-right font-medium text-blue-600 dark:text-blue-400">{fmtUSD(customPricingPrice)}</TableCell>}
                      <TableCell className="text-right font-medium">{fmtINR(customPricingPrice)}</TableCell>
                    </TableRow>
                  )}
